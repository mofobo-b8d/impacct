package ch.mofobo.impacct.views.collaborativemasterdetail;

import ch.mofobo.impacct.data.entity.SamplePerson;
import ch.mofobo.impacct.data.service.SamplePersonService;
import ch.mofobo.impacct.views.MainLayout;
